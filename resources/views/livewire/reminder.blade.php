<div class="of-auto h100 cont" fixed bg-img="{{ asset('shubham-dhage-d96PxKZrJN8-unsplash.jpg') }}" b-scroll>
    <boxy>
        sandra: blue;
    </boxy>
    <div class="div-sm-12 div-lg-4 p1">
        <div class="b-card" bg="blue 1" blur night hover shadow>
            <div bx-head capsule bg="dark-gray" tx="white">Crear Recordatorio</div>
            <div bx-content capsule>
                <div class="cont">
                    <div class="b-form-area div-12">
            ...
            <div bx-footer capsule>
                <button class="b-btn-neon mt2" size="sm" rd="all" color="sandra"
                    wire:click="saveReminder">Guardar</button>
            </div>
        </div>
    </div>
            ...
            <div class="div-sm-12 div-lg-4 p1">
                <div class="b-card w100" bg="blue 1" blur night hover shadow>
                    ...
                    <div bx-section capsule>
                        ...
                        <select class="div-6 b-select mt1 {{ $this->changeColor($reminder->status->id) }}" night sm
                            wire:change="changeStatus({{ $reminder->id }})"
                            wire:model="changeStatus.{{ $reminder->id }}">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <div class="col-8">
                                    @if (@$isEdit[$reminder->id])
                                        <input autofocus type="text" wire:model="title"
                                            wire:keydown.enter="update('{{ $reminder->id }}')" />
                                    @else
                                        <h4 class="fw-bold text-info"
                                            wire:click="editTitle('{{ $reminder->id }}','{{ $reminder->title }}')">
                                            {{ $reminder->title }}</h4>
                                    @endif
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary"
                                    wire:click="delete({{ $reminder->id }},true)">Si</button>
                            </div>
                        </div>
                    </div>
                </div>
